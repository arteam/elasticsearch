 ...
 */
public record ResolvedIndices(List<String> local, List<String> remote) {
    ...
    /**
     * @return <code>true</code> if both the {@link #local () local} and {@link #remote () remote} index lists are empty.
     */
    ...
    /**
     * @return <code>true</code> if the {@link #remote () remote} index lists is empty, and the local index list contains the
