...
public class ClientYamlTestSectionTests extends AbstractClientYamlTestFragmentParserTestCase {
    ...
    public void testParseTestSectionWithDoSection() throws Exception {
        ...
        assertThat(testSection.name(), equalTo("First test section"));
        assertThat(testSection.skipSection(), equalTo(SkipSection.EMPTY));
        assertThat(testSection.executableSections().size(), equalTo(1));
        DoSection doSection = (DoSection) testSection.executableSections().get(0);
    ...
    public void testParseTestSectionWithDoSetAndSkipSectionsNoSkip() throws Exception {
        ...
        assertThat(testSection, notNullValue());
        assertThat(testSection.name(), equalTo("First test section"));
        assertThat(testSection.skipSection(), notNullValue());
        assertThat(testSection.skipSection().getLowerVersion(), equalTo(Version.fromString("6.0.0")));
        assertThat(testSection.skipSection().getUpperVersion(), equalTo(Version.fromString("6.2.0")));
        assertThat(testSection.skipSection().getReason(), equalTo("Update doesn't return metadata fields, waiting for #3259"));
        assertThat(testSection.executableSections().size(), equalTo(2));
        DoSection doSection = (DoSection) testSection.executableSections().get(0);
        assertThat(doSection.getCatch(), equalTo("missing"));
        assertThat(doSection.getApiCallSection(), notNullValue());
        assertThat(doSection.getApiCallSection().getApi(), equalTo("indices.get_warmer"));
        assertThat(doSection.getApiCallSection().getParams().size(), equalTo(2));
        assertThat(doSection.getApiCallSection().hasBody(), equalTo(false));
        SetSection setSection = (SetSection) testSection.executableSections().get(1);
    ...
    public void testParseTestSectionWithMultipleDoSections() throws Exception {
        ...
        assertThat(testSection, notNullValue());
        assertThat(testSection.name(), equalTo("Basic"));
        assertThat(testSection.skipSection(), equalTo(SkipSection.EMPTY));
        assertThat(testSection.executableSections().size(), equalTo(2));
        DoSection doSection = (DoSection) testSection.executableSections().get(0);
        ...
        doSection = (DoSection) testSection.executableSections().get(1);
        assertThat(doSection.getCatch(), nullValue());
        assertThat(doSection.getApiCallSection(), notNullValue());
    ...
    public void testParseTestSectionWithDoSectionsAndAssertions() throws Exception {
        ...
        assertThat(testSection.name(), equalTo("Basic"));
        assertThat(testSection.skipSection(), equalTo(SkipSection.EMPTY));
        assertThat(testSection.executableSections().size(), equalTo(10));
        ...
        MatchAssertion matchAssertion = (MatchAssertion) testSection.executableSections().get(2);
        assertThat(matchAssertion.getField(), equalTo("_index"));
        assertThat(matchAssertion.getExpectedValue().toString(), equalTo("test_1"));

        IsTrueAssertion trueAssertion = (IsTrueAssertion) testSection.executableSections().get(3);
        assertThat(trueAssertion.getField(), equalTo("_source"));

        matchAssertion = (MatchAssertion) testSection.executableSections().get(4);
        ...
        doSection = (DoSection) testSection.executableSections().get(5);
        assertThat(doSection.getCatch(), nullValue());
        assertThat(doSection.getApiCallSection(), notNullValue());
        assertThat(doSection.getApiCallSection().getApi(), equalTo("get"));
        assertThat(doSection.getApiCallSection().getParams().size(), equalTo(2));
        ...
        LengthAssertion lengthAssertion = (LengthAssertion) testSection.executableSections().get(6);
        ...
        IsFalseAssertion falseAssertion = (IsFalseAssertion) testSection.executableSections().get(7);
        assertThat(falseAssertion.getField(), equalTo("whatever"));

        GreaterThanAssertion greaterThanAssertion = (GreaterThanAssertion) testSection.executableSections().get(8);
        ...
        LessThanAssertion lessThanAssertion = (LessThanAssertion) testSection.executableSections().get(9);
    ...
    public void testSmallSection() throws Exception {
        ...
        ClientYamlTestSection testSection = ClientYamlTestSection.parse(parser);
        assertThat(testSection, notNullValue());
        assertThat(testSection.name(), equalTo("node_info test"));
        assertThat(testSection.executableSections().size(), equalTo(3));
    }
}
