...
public final class RepositoryData {
     ...
     * @param slmPolicy       May be null if unknown, which happens if the snapshot was taken before 7.16 and hasn't been updated yet. Empty string indicates that this snapshot was not created by an SLM policy.
     */
